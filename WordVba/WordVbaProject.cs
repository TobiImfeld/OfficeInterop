...
namespace WordVba
{
    ...
    public class WordVbaProject
    {
        ...
        /// Project references
        /// </summary>        
        public WordVbaReferenceCollection References { get; set; }
        /// <summary>
        /// Code Modules (Modules, classes, designer code)
        /// </summary>
        public ExcelVbaModuleCollection Modules { get; set; }
        WordVbaSignature _signature = null;
        /// <summary>
        /// The digital signature
        /// </summary>
        public WordVbaSignature Signature
        {
            get
            {
                if (_signature == null)
                {
                    _signature = new WordVbaSignature(Part);
                }
                return _signature;
            }
        }
        WordVbaProtection _protection = null;
        /// <summary>
        /// VBA protection 
        /// </summary>
        public WordVbaProtection Protection
        {
            get
            {
                if (_protection == null)
                {
                    _protection = new WordVbaProtection(this);
                }
                return _protection;
            }
        }
            ...
            foreach (var modul in Modules)
            {
                ...
                while (pos + 9 < code.Length && code.Substring(pos, 9) == "Attribute")
                {
                    ...
                    if (lineSplit.Length > 1)
                    {
                        ...
                        var attr =
                            new WordVbaModuleAttribute()
                            {
                                Name = lineSplit[0].Trim(),
                                DataType = lineSplit[1].StartsWith("\"") ? AttributeDataType.String : AttributeDataType.NonString,
        ...
        private void ReadDirStream()
        {
            ...
            WordVbaReference currentRef = null;
            string referenceName = "";
            WordVbaModule currentModule = null;
            ...
            while (br.BaseStream.Position < br.BaseStream.Length && terminate == false)
            {
                ...
                switch (id)
                {
                    ...
                    case 0x0D:
                        ...
                        var regRef = new WordVbaReference();
                        ...
                        break;
                    case 0x0E:
                        var projRef = new WordVbaReferenceProject();
                    ...
                    case 0x16:
                        ...
                        break;
                    case 0x19:
                        currentModule = new WordVbaModule();
                    ...
                    case 0x10:
                        ...
                        break;
                    case 0x30:
                        var extRef = (WordVbaReferenceControl)currentRef;
                        ...
                        break;
                    case 0x33:
                        currentRef = new WordVbaReferenceControl();
                        ...
                        break;
                    case 0x2F:
                        var contrRef = (WordVbaReferenceControl)currentRef;
        ...
        private void WriteNameReference(BinaryWriter bw, WordVbaReference reference)
        {
            //Name record
        ...
        private void WriteControlReference(BinaryWriter bw, WordVbaReference reference)
        {
            WriteOrginalReference(bw, reference);

            bw.Write((ushort)0x2F);
            var controlRef = (WordVbaReferenceControl)reference;
        ...
        private void WriteOrginalReference(BinaryWriter bw, WordVbaReference reference)
        {
        ...
        private void WriteProjectReference(BinaryWriter bw, WordVbaReference reference)
        {
            bw.Write((ushort)0x0E);
            var projRef = (WordVbaReferenceProject)reference;
        ...
        private void WriteRegisteredReference(BinaryWriter bw, WordVbaReference reference)
        {
        ...
        internal WordVbaModuleAttributesCollection GetDocumentAttributes(string name, string clsid)
        {
            var attr = new WordVbaModuleAttributesCollection();
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_Name", Value = name, DataType = AttributeDataType.String });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_Base", Value = clsid, DataType = AttributeDataType.String });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_GlobalNameSpace", Value = "False", DataType = AttributeDataType.NonString });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_Creatable", Value = "False", DataType = AttributeDataType.NonString });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_PredeclaredId", Value = "True", DataType = AttributeDataType.NonString });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_Exposed", Value = "False", DataType = AttributeDataType.NonString });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_TemplateDerived", Value = "False", DataType = AttributeDataType.NonString });
            attr.list.Add(new WordVbaModuleAttribute() { Name = "VB_Customizable", Value = "True", DataType = AttributeDataType.NonString });
